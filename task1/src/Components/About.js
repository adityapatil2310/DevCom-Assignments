    ...
    <>
        <div className="d-flex justify-content-around" style={{marginTop:"150px"}}>
            ...
            <div className='container'>
                <h2 className='mt-5'>Hi, <br />I am Aditya <br /> <br /><br /> <span style={{fontSize:"20px"}}>I am currently a first year student at IIT Bombay pursuing BTech. in Civil Engineering.
